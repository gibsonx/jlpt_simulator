...
- 問題1 のことばの読み方として最もよいものを、1・2・3・4から一つえらびなさい (kanji_reading) 6 questions in total: 2 are nouns, 2 are verbs, 1 is an adjective, and 1 is an adverb
- 問題2（　）に入れるのに最もよいものを、1・2・3・4から一つえらびなさい。 (word_meaning) 7 questions in total: 2 are nouns, 2 are verbs, 2 are adjectives, and 1 is an adverb.
- 問題3 に意味が最も近いものを、1・2・3・4から一つえらびなさい。(synonym_substitution) 6 questions in total: 2 are nouns, 3 are verbs, and 1 is an adjective.
- 問題4 つぎのことばの使い方として最もよいものを、1・2・3・4から一つえらびなさい。 (word_usage) 6 questions in total: 3 noun, and 2 verbs and 1 another.

Section 2: Grammar
- 問題6 つぎの文の（　　　）に入れるのに最もよいものを、１・２・３・４から一つえらびなさい。(sentence_grammar) 10 questions in total: the first 1 is honorific speech, next 1 adverb, 1 auxiliary word, and other 10 different sentence structures
- 問題7 つぎの文の ★ に入る最もよいものを、1・2・3・4から一つえらびなさい。(sentence_sort) 5 questions in total.
- 問題8 つぎの文章を読んで、文章全体の内容を考えて、文中の 19 から 22 の中に入る最もよいものを、1・2・3・4から一つえらびなさい (sentence_structure) 1 article
...
- 問題2 では、まず質問を聞いてください。そのあと、問題用紙を見てください。読む時間があります。それから話を聞いて、問題用紙の1から4の中から、最もよいものを一つえらんでください。 (keypoint_understanding): 6 questions
...
full_exam_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            (
                "You are a Japanese teacher tasked with creating an outline for a JLPT N1 level exam paper." 
...
- 問題2（　）に入れるのに最もよいものを、1・2・3・4から一つえらびなさい。 (word_meaning) 1 question
- 問題3 に意味が最も近いものを、1・2・3・4から一つえらびなさい。(synonym_substitution) 1 question
- 問題4 つぎのことばの使い方として最もよいものを、1・2・3・4から一つえらびなさい。 (word_usage) 1 question

Section 2: Grammar
- 問題6 つぎの文の（　　　）に入れるのに最もよいものを、１・２・３・４から一つえらびなさい。(sentence_grammar) 1 question
- 問題7 つぎの文の ★ に入る最もよいものを、1・2・3・4から一つえらびなさい。(sentence_sort) 1 question
- 問題8 つぎの文章を読んで、文章全体の内容を考えて、文中の 19 から 22 の中に入る最もよいものを、1・2・3・4から一つえらびなさい (sentence_structure) 1 article
...
- 問題1-3 つぎの文章を読んで、質問に答えなさい。答えは、1・2・3・4から最もよいものを一つえらびなさい (short_passage_narrative_read): 1 article
- 問題1-4 つぎの文章を読んで、質問に答えなさい。答えは、1・2・3・4から最もよいものを一つえらびなさい (short_passage_notification_read): 1 article
- 問題2 つぎの(1)と(2)の文章を読んで、質問に答えなさい。答えは、1・2・3・4から最もよいものを一つえらびなさい。 (midsize_passage_read): 1 articles
- 問題3 つぎの文章を読んで、質問に答えなさい。答えは、1・2・3・4から最もよいものを一つえらびなさい。(long_passage_read): 1 article
...
Section 4: Listening Comprehension
- 問題1 では、まず質問を聞いてください。それから話を聞いて、問題用紙の1から4の中から、最もよいものを一つえらんでください。 (topic_understanding_txt): 1 question
...
- 問題4 では、問題用紙に何もいんさつしていません。まず文を聞いてください。それから、そのへんしを聞いて、1 から 3 の中から、最もよいものを一つえらんでください。 (immediate_ack): 1 questions
- 問題5-1 では、長めの話を聞きます。この問題には練習はありません。問題用紙にメモをとってもかまいません。 (comprehensive_expression_listen_answer) 1 question
