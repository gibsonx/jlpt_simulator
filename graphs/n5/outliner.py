...
full_exam_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            (
                "You are a Japanese teacher tasked with creating an outline for a JLPT N5 level exam paper."
                "The overall difficulty should be appropriate for the N5 level.\n"
